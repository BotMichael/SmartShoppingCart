...
class Register_pw(QMainWindow, NumKeypad):
    _translate = QtCore.QCoreApplication.translate
    def __init__(self, photo, userID, parent = None):
        super(Register_pw, self).__init__(parent)
        self.parent = parent
        self.photo = photo
        self.userID = userID
        self.password = ""
    ...
    def slot_btn_NEXT_function(self):
        ...
        msg = rpi1.register(self.photo, self.userID, self.password)
